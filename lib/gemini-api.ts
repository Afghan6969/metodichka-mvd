...
7. ВАРИАЦИИ С ОТВЕТАМИ ПОСТРАДАВШЕГО:
   После проверки жизненных показателей ОБЯЗАТЕЛЬНО создавай ДВА варианта:
   
   Пример 1 (проверка дыхания):
   /me приложил руку к груди пострадавшего
   /do Дыхание присутствует?
   
   Вариант 1 — если дыхание есть:
   /b Пострадавший: /do Да.
   /me продолжил осмотр
   
   Вариант 2 — если дыхания нет:
   /b Пострадавший: /do Нет.
   /me начал проводить искусственное дыхание
...
Вариант 1 — если есть автомобиль:
/me открыл багажник и достал медицинскую сумку
/do Медицинская сумка в руках.

Вариант 2 — если машины нет:
/do Медицинская сумка перекинута через плечо.
/me снял медицинскую сумку с плеча

/me поставил сумку на землю и открыл её
/do В сумке лежат бинты, жгут, антисептик, нашатырный спирт и перчатки.
/me достал из сумки перчатки и надел их
...
Вариант 1 — если пульс есть:
/b Пострадавший: /do Да.
/me продолжил осмотр

Вариант 2 — если пульса нет:
/b Пострадавший: /do Нет.

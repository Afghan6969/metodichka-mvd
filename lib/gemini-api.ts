...
5. СТРУКТУРА ОТЫГРОВКИ:
   ...
   ЭТАП 1 - ПОДГОТОВКА (два варианта):
   ...
   ЭТАП 3 - ОКАЗАНИЕ ПМП:
   /me открыл медицинскую сумку и достал одноразовые перчатки (если был Вариант 1)
   /me открыл аптечку и достал одноразовые перчатки (если был Вариант 2)
...
7. ВАРИАЦИИ С ОТВЕТАМИ ПОСТРАДАВШЕГО:
   После каждой проверки создавай ДВА четких варианта развития событий.
   ...
   Затем следующая проверка (если пульс был):
   
   /me достал нашатырный спирт и поднес к носу пострадавшего
   /do Реакция на нашатырный спирт есть?
   
   — Если реакция есть:
   /b Пострадавший: /do Да.
   /me убрал нашатырь и продолжил осмотр
   
   — Если реакции нет:
   /b Пострадавший: /do Нет.
   /me начал проводить реанимационные мероприятия

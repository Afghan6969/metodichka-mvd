...
"Определенное место (участок местности, помещение), на котором размещается наряд для выполнения поставленных задач.",
 ...
 className="pl-12 h-14 text-base border-2 border-blue-400/30 rounded-xl bg-black/5 font-semibold focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 text-white placeholder:text-blue-200/60"
 />
 </div>

 <div className="space-y-4">
 {filteredTerms.map((item, index) => (
 <div key={index} className="bg-white/8 border border-white/15 rounded-3xl group hover:bg-white/12 hover:border-white/25 transition-colors duration-200 overflow-hidden">
 <div className="p-6">

...
export function TrainingPage() {
 ...
 <div
 key={training.id}
 className="bg-white/8 border border-white/15 rounded-3xl group hover:bg-white/12 hover:border-white/25 transition-colors duration-200 overflow-hidden"
 >
 ...
 <div className="w-12 h-12 bg-gradient-to-br from-blue-500/80 to-blue-600/60 rounded-2xl flex items-center justify-center border border-blue-400/30 shadow-lg group-hover:shadow-blue-500/20 transition-colors duration-200">
 ...
 <div className="mt-4 bg-black/5 p-6 rounded-2xl border border-white/10">

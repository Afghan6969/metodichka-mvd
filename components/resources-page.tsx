...
export function ResourcesPage() {
 ...
 <div key={category} className="bg-white/8 border border-white/15 rounded-3xl group hover:bg-white/12 hover:border-white/25 transition-colors duration-200 overflow-hidden">

...
export function LoginModal({ isOpen, onClose }: LoginModalProps) {
 ...
 <DialogContent className="sm:max-w-md bg-card border-2 border-primary/30 shadow-lg shadow-primary/20">
 <DialogHeader>

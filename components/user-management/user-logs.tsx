...
export function UserLogs({ logs, actionDisplayNames, onRollback, showRollback = false, currentUserRole, currentUserId, showDetails = true }: UserLogsProps) {
 ...
 <div
 key={log.id}
 className="bg-white/8 border border-white/15 rounded-3xl p-6 group hover:bg-white/12 hover:border-white/25 transition-colors duration-200"
 >
 ...
 <DialogContent className="max-w-2xl bg-white/10 border border-white/20">
 <DialogHeader>

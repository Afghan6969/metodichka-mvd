...
export function ModernHeader({ onMenuClick, onSearchClick }: ModernHeaderProps) {
 ...
 className="rounded-xl h-10 px-4 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-sm shadow-lg hover:shadow-md transition-all duration-200"
 >

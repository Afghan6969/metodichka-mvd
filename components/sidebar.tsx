...
export function Sidebar({ currentPage, onPageChange, onGlobalSearchOpen }: SidebarProps) {
  ...
  const commonItems = [
    ...
    { id: "reports" as const, icon: Radio, label: "Доклады в рацию", priority: 5 },
    { id: "ranks" as const, icon: Star, label: "Звания и ранги", priority: 6 },
    { id: "commands" as const, icon: Terminal, label: "Команды", priority: 7 },
    { id: "ammunition" as const, icon: Shield, label: "Аммуниция", priority: 8 },
    { id: "terms" as const, icon: Book, label: "Термины", priority: 9 },
    { id: "resources" as const, icon: ExternalLink, label: "Ресурсы", priority: 10 },
  ]

  const gibddItems = [
    { id: "gibdd-positions" as const, icon: Users, label: "Должности ГИБДД" },
    { id: "gibdd-vehicles" as const, icon: Car, label: "Автопарк ГИБДД" },
    { id: "gibdd-gov-wave" as const, icon: Megaphone, label: "Гос волна УБ" },
  ...
  const guvdItems = [
    ...
    { id: "guvd-gov-wave" as const, icon: Megaphone, label: "Гос волна ПА" },

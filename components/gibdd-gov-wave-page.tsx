          ...
          <Card className="p-8 bg-gray-800 shadow-xl border-gray-700 rounded-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="text-center pt-4 border-t border-gray-600">
                <p className="text-xs text-gray-400">Доступ предоставляется только авторизованному персоналу ГИБДД</p>
              </div>
            </div>
          </Card>
        </div>
  ...
  return (
    <div className="flex-1 p-8 overflow-auto bg-gray-900">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-8">Гос волна ГИБДД - УБ (Учебный батальон)</h1>

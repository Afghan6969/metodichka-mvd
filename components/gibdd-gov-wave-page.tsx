...
export function GibddGovWavePage() {
    ...
    return (
      <div className="flex-1 p-8 overflow-auto">
        <div className="max-w-md mx-auto mt-20">
          <Card className="p-8 shadow-lg border-2 border-orange-200">
            <div className="text-center mb-6">
              <div className="mx-auto w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mb-4">
                <Shield className="h-8 w-8 text-orange-600" />
              </div>
              <h1 className="text-2xl font-bold text-orange-600 mb-2">Доступ к Гос волне УБ</h1>
            ...
            <div className="space-y-4">
              ...
              <Button onClick={handlePasswordSubmit} className="w-full h-12 bg-orange-600 hover:bg-orange-700">
                Войти в систему
              </Button>
            </div>
          </Card>
  ...
  const generateMessages = (time: string, city: string) => {
    ...
    return {
      announcement: `gov Сегодня в ${interviewTime} состоится собеседование в Учебный Батальон ${tag}. Место: участок г. ${city}. Ждём всех желающих!\ngov Требования: опрятность, юр. образование, медкарта, военный билет, полный пакет документов, прописка от 5 лет`,

      start: `gov Собеседование в Учебный Батальон ${tag} начато! Ждём в участке г. ${city}. Не упусти шанс начать карьеру!\ngov Требования: опрятность, юр. образование, медкарта, военный билет, полный пакет документов, прописка от 5 лет`,

      continue: `gov Собеседование в Учебный Батальон ${tag} продолжается! Ждём вас в участке г. ${city}. Не упустите шанс стать частью команды!\ngov Требования: опрятность, юр. образование, медкарта, военный билет, полный пакет документов, прописка от 5 лет`,

      end: `gov Собеседование в Учебный Батальон ${tag} окончено. Открыт приём эл. заявлений на трудоустройство в званиях Рядовой и Старшина.\ngov Есть опыт службы в ГИБДД? Подайте заявление на восстановление в звании и должности через гос. портал республики.`,
    }
  }
  ...
  return (
    <div className="flex-1 p-8 overflow-auto">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-orange-600 mb-8">Гос волна ГИБДД - УБ (Учебный батальон)</h1>
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 border-l-4 border-l-orange-400">
            <h2 className="text-xl font-semibold text-orange-700 mb-4">Временная схема</h2>
            <div className="text-sm text-gray-700 space-y-2">
              <p>

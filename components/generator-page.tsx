...
"w-60 transition-colors duration-200 ease-in-out transform hover:scale-105",
 ...
 />
 <FioInput fio={fio} setFio={setFio} label="Ваше ФИО (лидер)" placeholder="Nick_Name" />
 <DateRangeInputs
 fromDate={fromDate}
 toDate={toDate}
...
"mr-2 h-4 w-4",
 ...
 {/* Examples Section */}
 {department && reportType && (
 <Card className="relative bg-gradient-to-br from-slate-50/80 via-gray-50/60 to-zinc-50/40 dark:from-slate-900/30 dark:via-gray-900/20 dark:to-zinc-900/10 border-2 border-border/60 shadow-md overflow-hidden">

...
export function PageHeader({ icon: Icon, title, description, badge }: PageHeaderProps) {
 ...
 <div className="relative w-16 h-16 bg-gradient-to-br from-primary to-primary/70 rounded-2xl flex items-center justify-center border-2 border-primary/50 shadow-md shadow-primary/30">

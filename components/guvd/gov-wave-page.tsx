...
export function GuvdGovWavePage() {
 ...
 <div className="bg-white/8 border border-white/15 rounded-3xl p-8 shadow-md">
 ...
 Для доступа к гос волне ГУВД необходимо войти в систему. Нажмите кнопку"Войти" в шапке сайта.
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-br from-red-500/10 via-red-600/5 to-transparent border border-red-400/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-red-500/10 transition-colors duration-200">
 ...
 <div className="bg-gradient-to-br from-green-500/10 via-green-600/5 to-transparent border border-green-400/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-green-500/10 transition-colors duration-200">
 ...
 <div className="bg-gradient-to-br from-blue-500/10 via-blue-600/5 to-transparent border border-blue-400/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-blue-500/10 transition-colors duration-200">
 ...
 <div className="bg-gradient-to-br from-purple-500/10 via-purple-600/5 to-transparent border border-purple-400/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-purple-500/10 transition-colors duration-200">
 ...
 <div className="bg-white/5 border border-white/10 rounded-xl hover:bg-white/8 hover:border-white/15 transition-all duration-200">
 <div className="p-4">

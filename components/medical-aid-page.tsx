...
"/me расстегнул застёжку на поясе и взял аптечку, поставив её рядом с пострадавшим",
"/me открыл аптечку",
...
"/do Пострадавший в стабильном состоянии."
 ...
 description="Подробные инструкции по оказанию ПМП"
 ...
 {/* Таблица примеров */}
 <div className="bg-white/8 border border-white/15 rounded-3xl p-8 hover:bg-white/12 hover:border-white/25 transition-colors duration-200">

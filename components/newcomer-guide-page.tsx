...
"Следите за обновлениями в регламенте"
 ...
 <div key={index} className="group relative bg-card border border-border hover:border-primary/40 rounded-2xl overflow-hidden hover:shadow-md hover:shadow-primary/5 transition-colors duration-200">
 <div className="absolute inset-0 bg-gradient-to-br from-primary/0 via-primary/0 to-primary/0 group-hover:from-primary/5 group-hover:via-primary/3 group-hover:to-primary/5 transition-colors duration-200 pointer-events-none"></div>
 ...
 <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500/30 to-green-500/30 dark:from-emerald-500/40 dark:to-green-500/40 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-colors duration-200 shadow-lg">
 ...
 <div 
 key={index} 
 className={`group relative bg-gradient-to-br ${section.bgGradient} border-2 ${section.borderGradient} rounded-2xl p-6 hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-1 transition-colors duration-200 overflow-hidden cursor-pointer`}
 ...
 <div className="flex-shrink-0">
 <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${section.gradient} shadow-lg flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-colors duration-200`}>
 ...
 <div className="flex items-center gap-2 text-primary text-sm font-semibold group-hover:gap-3 transition-colors duration-200">

...
export function EducationPage() {
 ...
 <div 
 key={lecture.id} 
 className="group relative bg-card border border-border hover:border-primary/40 rounded-2xl overflow-hidden hover:shadow-lg hover:shadow-primary/5 transition-colors duration-200"
 >

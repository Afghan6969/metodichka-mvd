...
say Первым действием обязательно включите световые и звуковые сигналы — специальные громкоговорители и маячки, чтобы оповестить всех участников дорожного движения о вашем преследовании.
...
export function LecturesPage() {
 ...
 <h3 className="text-lg font-bold uppercase tracking-wide mb-2 text-white group-hover:text-blue-200 transition-colors">{lecture.title}</h3>
 ...
 <p className="text-xl font-bold text-white mb-2">Лекции не найдены</p>
